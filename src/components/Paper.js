...
const Paper = () => {
  ...
  const paperScrapItems = [
    {
      id: 1,
      name: "Books/Copy",
      price: 15.0,
      minOrder: 250.0,
      image: "product/book.jpeg",
    },
    {
      id: 2,
      name: "News Paper",
      price: 21.0,
      minOrder: 250.0,
      image: "product/newspaper.jpeg",
    },
    {
      id: 3,
      name: "Gatta/Corrugation",
      price: 12.0,
      minOrder: 250.0,
      image: "product/gatta.webp",
    },
    {
      id: 4,
      name: "Magazines",
    ...
    },
    {
      ...
      price: 1.0,
      minOrder: 250.0,
      image: "product/mill-board-paper-1000x1000.webp",
    },
  ];
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-3/4">
          <h1 className="mb-6 text-2xl font-bold">Paper</h1>
          <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {paperScrapItems.map((product, index) => (
              <li
                key={index}

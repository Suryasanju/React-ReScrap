...
const ElectronicItems = () => {
  ...
  const ElectronicItems = [
    {
      id: 1,
      name: "Washing Machine per piece",
      price: 750.0,
      minOrder: 750.0,
      image: "/product/washingmachine.jpg",
    },
    {
      id: 2,
      name: "AC 1.5tn PP Copper Wiring",
      price: 4000.0,
      minOrder: 3500.0,
      image: "/product/air-conditioner-india-feature.webp",
    },
    {
      id: 3,
      name: "AC 1tn PP Copper Wiring",
      price: 2700.0,
      minOrder: 2000.0,
      image: "/product/air-conditioner-india-feature.webp",
    },
    ...
    {
      id: 6,
      name: "Double Door Fridge per piece",
      price: 1200.0,
      minOrder: 1100.0,
      image: "/product/double-door-refrigerator.jpg",
    },
    {
      id: 7,
      name: "Battery",
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-3/4">
          <h1 className="mb-6 text-2xl font-bold">Electronic Items</h1>
          <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ElectronicItems.map((product, index) => (
              <li
                key={index}

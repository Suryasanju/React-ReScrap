...
const IronItem = () => {
  ...
  const IronScrapItems = [
    {
      id: 1,
      name: "Iron",
      price: 30.0,
      minOrder: 250.0,
      image: "/product/metal.jpg",
    },
    {
      id: 2,
      name: "Tin/Light Iron",
    ...
    },
    {
      ...
      price: 2500.0,
      minOrder: 2200.0,
      image: "/product/bike.jpeg",
    },
    {
      id: 4,
      name: "Scooter per piece",
      price: 2300.0,
      minOrder: 2000.0,
      image: "/product/scooty.jpeg",
    },
  ];
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-3/4">
          <h1 className="mb-6 text-2xl font-bold">IronItems</h1>
          <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {IronScrapItems.map((product, index) => (
              <li
                key={index}
